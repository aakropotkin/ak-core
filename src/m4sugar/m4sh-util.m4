...
# AS_UTIL_FILE_TO_STRING(FILE, [VAR = filestr])
# ---------------------------------------------
# Read contents of FILE to a string held in shell variable VAR.
m4_define([AS_UTIL_FILE_TO_STRING],
[m4_default_nblank([$2], [filestr])="AS_ESCAPE(m4_include($1))"[]dnl
])# AS_UTIL_FILE_TO_STRING
